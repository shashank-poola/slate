...
export default function DashboardPage() {
  return (
    <main className="min-h-svh bg-[#fdfdfc] text-[#171717]">
      <SiteHeader />
      <section className="mx-auto max-w-[760px] px-6 pb-24 pt-20 sm:px-0">
        ...
        <p className="mt-5 max-w-xl text-base leading-7 text-zinc-600">Turn researcher notes into reviewed CRediT roles, publication-ready statements, and manuscript changes.</p>
        <DeclareWorkspace />
      </section>
    </main>
  );
